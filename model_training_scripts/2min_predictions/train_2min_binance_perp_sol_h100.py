#!/usr/bin/env python3
"""
H100 Scaled 2-Minute SOL Binance Perp Forecasting Model
Uses proven multi-GPU architecture with target-specific predictions

Based on working train_working_scaled.py but adapted for 2min SOL predictions
"""
...
MODEL_SAVE_DIR = "models/2min_binance_perp_sol_h100"
...
# Target configuration for 2-minute SOL predictions
TARGET_MINUTES = 2
TARGET_STEPS = 24  # 2 min * 60 sec/min / 5 sec/step
TARGET_PAIR = "SOL-USDT"
TARGET_EXCHANGE = "binance_perp"

# Set up logging
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
logger = logging.getLogger("2min_sol_h100_training")
...
def main():
    ...
    logger.info("🚀 H100 Scaled 2-Minute SOL Training Started!")
